...
public interface EnrollmentRepository extends JpaRepository<Enrollment, Long> {
    ...
    // 강의별 완강 수 집계 (정산 대상)
    @Query("SELECT e.lectureId AS lectureId, COUNT(e) AS count FROM Enrollment e WHERE e.status = com.teamexp.learnflowapi.enrollment.model.EnrollmentStatus.COMPLETED GROUP BY e.lectureId")
